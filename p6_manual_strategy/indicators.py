...
class Indicators(object):
    ...
    def generate_charts(self):
        ...
        self.sma(prices=prices, lookback=lookback, make_plot=True)
        self.bbp(prices, lookback, True)
        self.macd(prices, True)

    #
    def sma(self, prices, lookback, make_plot):
    ...
    #
    def bbp(self, prices, lookback, make_plot):
        sma_df, _ = self.sma(prices=prices, lookback=lookback, make_plot=False)
